...
const BehanceIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M22 7h-7v3h7V7zm1.326 9.492c-.624.908-1.747 1.411-2.924 1.411-1.352 0-2.285-.367-2.981-.884-.852-.633-1.284-1.733-1.284-3.268 0-1.928.66-3.136 1.638-3.905.811-.637 1.831-.836 2.627-.836 1.258 0 2.385.498 3.012 1.547.45.753.541 1.782.541 2.454h-5.065c.035 1.436.726 1.914 1.638 1.914.73 0 1.206-.277 1.492-.727h1.306zm-4.735-3.834h3.29c-.063-1.077-.665-1.577-1.546-1.577-.96 0-1.637.593-1.744 1.577zm-9.529 3.034c.905 0 1.514-.268 1.968-.707.545-.529.742-1.343.742-2.155 0-.584-.131-1.111-.355-1.53-.332-.622-.924-1.006-1.564-1.159.58-.224 1.053-.66 1.304-1.268.225-.544.298-1.062.298-1.579 0-1.731-1.293-2.812-3.411-2.812H2v11.21h7.062zM5.337 4.844h2.528c1.17 0 1.733.488 1.733 1.473 0 1.043-.727 1.646-1.871 1.646H5.337V4.844zm0 4.364h2.895c1.229 0 1.962.622 1.962 1.741 0 1.158-.87 1.876-2.072 1.876H5.337V9.208z" />
  </svg>
);
...
const SocialLinks = () => (
  <div className="flex gap-4 mt-6">
    <a
      href="https://www.facebook.com/salman.islam.855944/"
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 hover:text-[#1877F2] transition-colors hover:scale-110 transform duration-200"
      aria-label="Facebook"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 hover:text-[#0A66C2] transition-colors hover:scale-110 transform duration-200"
      aria-label="LinkedIn"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 hover:text-[#1769FF] transition-colors hover:scale-110 transform duration-200"
      aria-label="Behance"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 hover:text-[#EA4C89] transition-colors hover:scale-110 transform duration-200"
      aria-label="Dribbble"
    >
...
const SectionHeader: React.FC<{ title: string; subtitle?: string }> = ({
  ...
  <div className="mb-8 border-b-2 border-brand-accent/20 pb-4">
    <h2 className="text-3xl font-bold font-serif text-brand-dark dark:text-white">
      {title}
    </h2>
    {subtitle && (
...
const DashboardWidgets: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 border-t border-gray-100 dark:border-gray-800">
      <SectionHeader
        title="Live from Dhaka"
        subtitle="Real-time updates from the heart of Bangladesh"
      />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center animate-in zoom-in duration-500 hover:border-brand-accent/50 transition-colors">
          ...
          <h3 className="text-3xl font-bold font-mono text-gray-800 dark:text-white mb-1">
            {dhakaTime}
          </h3>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center animate-in zoom-in duration-500 delay-200 hover:border-shop-orange/50 transition-colors group">
          <CloudSun
            size={48}
            className="text-shop-orange mb-4 group-hover:scale-110 transition-transform"
          />
    ...
    <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
      <div>
        ...
        <p className="text-gray-400 text-sm leading-relaxed">
          Crafting digital experiences with passion and precision. Specialized
          in modern graphic design and scalable web architectures.
        </p>
        <SocialLinks />
      </div>
      <div>
        ...
        <ul className="space-y-2 text-sm text-gray-300">
          ...
          <li>
            <button
              onClick={() => setView(ViewType.GRAPHIC_DESIGN)}
              className="hover:text-white transition-colors"
            >
              Graphic Portfolio
            </button>
      ...
      <div>
        ...
        <button
          ...
          className="text-sm text-gray-400 hover:text-white underline flex items-center gap-2"
        >
...
const HomeView: React.FC<{ data: AppData; setView: (v: ViewType) => void }> = ({
  data,
  setView,
}) => (
  <div className="animate-in fade-in duration-500">
    ...
    <div className="relative h-[70vh] bg-gradient-to-r from-brand-dark to-slate-800 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Professional Graphic Design (7 Years) & Full-Stack Web Development (3
          Years). Currently shaping digital solutions at{" "}
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            onClick={() => setView(ViewType.GRAPHIC_DESIGN)}
            className="px-8 py-3 bg-brand-accent hover:bg-indigo-600 text-white rounded-full font-bold transition-transform hover:scale-105 shadow-lg shadow-brand-accent/25"
          >
            View My Work
          </button>
          <button
            onClick={() => setView(ViewType.CONTACT)}
            className="px-8 py-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white hover:text-brand-dark rounded-full font-bold transition-colors"
          >
            Contact Me
          </button>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={idx}
              className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-white dark:hover:bg-gray-700 shadow-sm hover:shadow-xl transition-all text-center group cursor-default"
            >
    ...
    <div className="max-w-7xl mx-auto px-4 py-16 border-t border-gray-100 dark:border-gray-800">
      <SectionHeader
        ...
        subtitle="Latest updates, products, and portfolio highlights"
      />
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Card 1: News */}
        <div
          onClick={() => setView(ViewType.NEWS)}
          className="group cursor-pointer bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all border border-gray-100 dark:border-gray-700"
        >
          ...
          <div className="p-6">
            <p className="text-gray-600 dark:text-gray-300">
              Stay updated with the latest in tech and design from Bangladesh
              and beyond.
            </p>
            <div className="mt-4 flex items-center text-news-red font-semibold">
        ...
        {/* Card 2: E-commerce */}
        <div
          onClick={() => setView(ViewType.ECOMMERCE)}
          className="group cursor-pointer bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all border border-gray-100 dark:border-gray-700"
        >
          ...
          <div className="p-6">
            <p className="text-gray-600 dark:text-gray-300">
              Browse exclusive digital products and design assets in our shop.
            </p>
            <div className="mt-4 flex items-center text-shop-orange font-semibold">
        ...
        >
          ...
          <div className="p-6">
            <p className="text-gray-600 dark:text-gray-300">
              Explore 7 years of graphic design and 3 years of web development
              excellence.
            </p>
            <div className="mt-4 flex items-center text-brand-accent font-semibold">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div className="lg:col-span-3">
        <SectionHeader
          ...
          subtitle="Latest updates from Bangladesh and the World"
        />
        ...
        {items.length > 0 && (
          <div
            ...
            onClick={() => onViewDetail(items[0].id)}
          >
            ...
            <span className="text-news-red font-bold uppercase text-sm tracking-wider">
              {items[0].category}
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-200 dark:border-gray-700 pt-8">
          {items.slice(1).map((item) => (
            ...
            >
              ...
              <div>
                <span className="text-news-red text-xs font-bold uppercase">
                  {item.category}
                </span>
                <h3 className="text-xl font-serif font-bold mt-1 group-hover:text-news-red transition-colors dark:text-white">
                  {item.title}
                </h3>
      ...
      <div className="lg:col-span-1 border-l border-gray-200 dark:border-gray-700 pl-8 hidden lg:block">
        <div className="sticky top-24">
          <h3 className="font-bold text-xl mb-4 text-news-red border-b-2 border-news-red pb-2 inline-block">
            Top News
          </h3>
          <ul className="space-y-4">
            {items.map((item, idx) => (
              <li
                ...
                onClick={() => onViewDetail(item.id)}
              >
                <h4 className="font-serif text-md font-semibold hover:text-news-red transition-colors dark:text-gray-200">
                  {item.title}
                </h4>
...
const NewsDetailView: React.FC<{ item: NewsItem; onBack: () => void }> = ({
  item,
  onBack,
}) => (
  <div className="max-w-4xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-bottom-4">
    <button
      onClick={onBack}
      className="flex items-center text-gray-500 hover:text-brand-accent transition-colors mb-6"
    >
...
const EcommerceView: React.FC<{
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 bg-gray-50 dark:bg-brand-dark min-h-screen">
      <SectionHeader
        title="Dark Store"
        subtitle="Exclusive digital and physical merchandise"
      />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {filteredProducts.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 group overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col"
              >
                <div
                ...
                >
                  ...
                  />
                  {discount > 0 && (
                    <div className="absolute top-2 right-2 bg-shop-orange text-white text-xs font-bold px-2 py-1 rounded">
                      -{discount}%
                    </div>
                  )}
                  {product.category && (
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="flex items-center gap-1 mb-2 mt-auto">
                    <span className="text-shop-orange text-lg font-bold">
                      ৳{product.price}
                    </span>
                    {product.originalPrice && (
...
const ProductDetailView: React.FC<{
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-right-4">
      <button
        onClick={onBack}
        className="flex items-center text-gray-500 hover:text-shop-orange transition-colors mb-8"
      >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center">
            <span className="text-shop-orange font-bold uppercase tracking-wider text-sm mb-2">
              {product.category}
            </span>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700 grid grid-cols-2 gap-4 text-sm text-gray-500">
              <div className="flex items-center gap-2">
                <CheckCircle size={16} className="text-green-500" /> In Stock
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle size={16} className="text-green-500" /> Fast
                Delivery
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle size={16} className="text-green-500" /> Genuine
                Product
              </div>
              <div className="flex items-center gap-2">
...
}> = ({ cart, updateQuantity, removeFromCart, setView }) => {
    ...
    <div className="max-w-4xl mx-auto px-4 py-12 min-h-screen">
      ...
      {cart.length === 0 ? (
        <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
          ...
          <button
            onClick={() => setView(ViewType.ECOMMERCE)}
            className="px-6 py-2 bg-brand-accent text-white rounded-full hover:bg-indigo-600 transition-colors"
          >
            Continue Shopping
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-4">
            {cart.map((item) => (
              <div
                key={item.id}
                className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm flex gap-4 items-center"
              >
                <img
                  src={item.image}
                  alt={item.name}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-shop-orange font-semibold">
                    ৳{item.price}
                  </p>
                </div>
                <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded px-2">
                  ...
                  <span className="w-6 text-center text-sm font-bold dark:text-white">
                    {item.quantity}
                  </span>
                  <button
                    onClick={() => updateQuantity(item.id, 1)}
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm h-fit">
            <h3 className="font-bold text-lg mb-4 border-b pb-2 dark:text-white">
              Order Summary
            </h3>
            ...
            <button
              onClick={() => setView(ViewType.CHECKOUT)}
              className="w-full bg-shop-orange hover:bg-orange-600 text-white font-bold py-3 rounded-lg transition-colors flex items-center justify-center gap-2"
            >
          ...
          <form onSubmit={handlePayment} className="space-y-4">
            ...
            <div className="pt-4">
              <button
                disabled={processing}
                type="submit"
                className="w-full bg-brand-accent hover:bg-indigo-600 text-white font-bold py-3 rounded-lg transition-colors disabled:opacity-50 flex justify-center items-center gap-2"
              >
                {processing ? (
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border dark:border-gray-700 h-fit">
          ...
          <ul className="space-y-2 mb-4 max-h-60 overflow-y-auto">
            {cart.map((item) => (
              <li
                key={item.id}
                className="flex justify-between text-sm dark:text-gray-300 border-b dark:border-gray-700 pb-2"
              >
                <span>
                  {item.name}{" "}
...
const PortfolioView: React.FC<{
  ...
  const filtered =
    type === "graphic"
      ? items.filter((i) =>
          ["logo", "poster", "banner", "thumbnail"].includes(i.category)
        )
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
              <span className="inline-block px-3 py-1 bg-brand-accent text-white text-xs font-bold rounded-full mb-2 w-max uppercase tracking-wide">
                {item.category}
              </span>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 backdrop-blur-sm p-4 animate-in fade-in duration-300">
          ...
          <div className="max-w-5xl w-full flex flex-col items-center">
            ...
            <div className="text-center max-w-2xl animate-in slide-in-from-bottom-4">
              ...
              <span className="inline-block px-3 py-1 bg-brand-accent text-white text-xs font-bold rounded-full mb-4 uppercase tracking-wide">
        ...
        <div className="px-8 pb-8">
          <div className="relative -mt-16 mb-6 flex justify-between items-end">
            <div className="w-32 h-32 rounded-full border-4 border-white dark:border-gray-800 bg-gray-200 overflow-hidden shadow-lg">
              <img
                src="https://scontent.fdac207-1.fna.fbcdn.net/v/t39.30808-1/457755090_487167044243615_3573487624675178014_n.jpg?stp=dst-jpg_s480x480_tt6&_nc_cat=105&ccb=1-7&_nc_sid=1d2534&_nc_ohc=Kmy1toKFOA0Q7kNvwHDIbkN&_nc_oc=Adl3q71T78o3kVAbQKPq_eFX5YTvHCyD1SEwjXtp5NBEkiWsPIG1wcZqUzG7lB64V28&_nc_zt=24&_nc_ht=scontent.fdac207-1.fna&_nc_gid=pUSiQRp19i2M8hiksK1gtA&oh=00_AfiSu_OeB2HN8Wc7n5qUVjUoyxxZsGO7BbyE4H6J3mco1A&oe=6929D584"
                alt="Profile"
                className="w-full h-full object-cover"
              />
            </div>
          ...
          <p className="text-brand-accent font-medium text-lg mb-6">
            Software Developer at Dynamic Megasoft Limited
          </p>

          <div className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
            <p className="mb-4">
              I am a professional graphic designer and web developer with a
              passion for creating creative and colorful digital experiences.
              With <strong className="text-brand-accent">7 years</strong> of
              experience in Graphic Design and{" "}
              <strong className="text-brand-accent">3 years</strong> in Web
              Design, I bridge the gap between aesthetics and functionality.
            </p>
            <p className="mb-6">
              Currently working at <strong>Dynamic Megasoft Limited</strong>{" "}
              since 2022, I specialize in building responsive, user-friendly
              applications and compelling visual identities.
            </p>

            <div className="mt-8">
              <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center gap-2">
                <Palette size={20} className="text-brand-accent" /> Graphic
                Design Skills
              </h3>
              <div className="flex flex-wrap gap-2 mb-6">
                {GRAPHIC_SKILLS.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-brand-accent hover:text-white transition-colors cursor-default border border-transparent hover:border-brand-accent/50"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center gap-2">
                <Monitor size={20} className="text-brand-accent" /> Web
                Development Skills
              </h3>
...
const ContactView: React.FC<{
  onSendMessage: (m: Omit<Message, "id" | "date">) => void;
}> = ({ onSendMessage }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="animate-in slide-in-from-left-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8">
            ...
            a message. I am always open to discussing new projects, creative
          ...
          {!submitted ? (
            ...
            <div className="flex flex-col items-center justify-center h-full py-12 text-center animate-in zoom-in">
              ...
              <p className="text-gray-500 dark:text-gray-300 max-w-sm">
                We will check your message early and give you feedback. Thank
...
const AdminView: React.FC<{
  ...
  const [activeTab, setActiveTab] = useState<
    "news" | "products" | "messages" | "portfolio"
  >("messages");
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-brand-dark px-4">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl max-w-md w-full border border-gray-100 dark:border-gray-700">
          <div className="text-center mb-6">
            <div className="w-12 h-12 bg-brand-accent rounded-lg flex items-center justify-center text-white font-bold text-xl mx-auto mb-2">
              D
            </div>
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-brand-accent hover:bg-indigo-600 text-white font-bold py-3 rounded-lg transition-colors mb-4"
            >
              Login to Dashboard
            </button>
  ...
  const handleAddItem = (e: React.FormEvent) => {
    ...
    if (activeTab === "news") {
      const item: NewsItem = {
        id,
        title: newItem.title,
        summary: newItem.desc,
        date: editId ? "Updated" : "Just Now",
        category: newItem.category || "Update",
        image,
      };
      setData((prev) => ({
        ...prev,
      ...
      const prod: Product = {
        ...
        originalPrice: newItem.originalPrice
          ? parseInt(newItem.originalPrice)
          : undefined,
        rating: 5,
        reviews: 0,
        image,
      ...
      setData((prev) => ({
        ...prev,
        products: editId
          ? prev.products.map((p) => (p.id === id ? prod : p))
          : [prod, ...prev.products],
      }));
      ...
      const pf: PortfolioItem = {
        id,
        title: newItem.title,
        category: (newItem.category as any) || "logo",
        image,
        description: newItem.desc,
      };
      setData((prev) => ({
        ...prev,
        portfolio: editId
          ? prev.portfolio.map((p) => (p.id === id ? pf : p))
          : [pf, ...prev.portfolio],
      }));
    }
    setNewItem({
          ...
          <table className="w-full text-left table-auto">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th className="p-4 dark:text-gray-300 text-right w-1/12">
                  Action
                </th>
              </tr>
            </thead>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleAddItem} className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <Star size={16} /> AI Generate Description
                  </>
                )}
              </button>
                ...
                <button
                  ...
                  className={`flex-1 ${
                    editId
                      ...
                      : "bg-brand-accent hover:bg-indigo-600"
                  } text-white py-2 rounded transition-colors flex items-center justify-center gap-2`}
                >
                  {editId ? (
                    <>
                      <Save size={16} /> Update
          ...
          <div className="lg:col-span-2 space-y-4">
            {(activeTab === "news"
              ...
              <div
                key={item.id}
                className={`bg-white dark:bg-gray-800 p-4 rounded-lg shadow flex justify-between items-center border ${
                  editId === item.id
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {item.category && (
                      <span className="text-xs bg-gray-200 dark:bg-gray-700 px-2 py-0.5 rounded dark:text-gray-300">
                        {item.category}
                      </span>
                    )}
                  </div>
...
export default function App() {
  ...
  const renderView = () => {
    switch (view) {
      ...
      case ViewType.NEWS:
        return (
          <NewsView items={data.news} onViewDetail={handleViewNewsDetail} />
        );
      ...
      case ViewType.PRODUCT_DETAIL:
        ...
        return productItem ? (
          <ProductDetailView
            product={productItem}
            onAddToCart={addToCart}
            onBack={() => setView(ViewType.ECOMMERCE)}
          />
        ) : (
          <EcommerceView
            products={data.products}
      ...
      case ViewType.CHECKOUT:
        return (
          <CheckoutView cart={cart} clearCart={clearCart} setView={setView} />
        );
